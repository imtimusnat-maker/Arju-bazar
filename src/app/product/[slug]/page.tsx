...
const MessengerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path d="m6.5 13.6 2.8-6.4 4.2 5.2 2.9-6.6-9.9 7.8z" />
  </svg>
);
                  ...
                  {settings?.messengerLink && (
                    <Button asChild className="w-full h-12 bg-black text-white hover:bg-gray-800 text-lg">
                        <Link href={settings.messengerLink} target="_blank">
                          <MessengerIcon className="mr-2 h-6 w-6 text-[#0084FF] fill-[#0084FF]" />
                          Chat with us
                        </Link>
                    </Button>
                  )}
                   {settings?.whatsappNumber && (
                    <Button asChild className="w-full h-12 bg-black text-white hover:bg-gray-800 text-lg">
                        <Link href={whatsAppUrl} target="_blank">
                            <WhatsAppIcon className="mr-2 h-6 w-6 text-[#25D366] fill-[#25D366]" />
                            WhatsApp Us
                        </Link>
                   </Button>
                   )}
